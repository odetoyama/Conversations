...
import com.ebdesk.ebconvo.services.AvatarService;
import com.ebdesk.ebconvo.services.XmppConnectionService;
import com.ebdesk.ebconvo.services.XmppConnectionService.XmppConnectionBinder;
				...
				nfcAdapter.setNdefPushMessageCallback(new NfcAdapter.CreateNdefMessageCallback() {
					...
					public NdefMessage createNdefMessage(NfcEvent nfcEvent) {
                        return new NdefMessage(new NdefRecord[]{
                                ...
                                NdefRecord.createApplicationRecord("com.ebdesk.ebconvo")
                        });
					}
				}, this);
			}
